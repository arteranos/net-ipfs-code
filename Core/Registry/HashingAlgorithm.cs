...
namespace Ipfs.Registry
{
    ...
    public class HashingAlgorithm
    {
        ...
        static HashingAlgorithm()
        {
            ...
            Register("shake-128", 0x18, 256 / 8, () => new BouncyDigest(new BC.ShakeDigest(128))); // BC says 256 bits digest
            Register("shake-256", 0x19, 512 / 8, () => new BouncyDigest(new BC.ShakeDigest(256))); // BC says 512 bits digest
